...
router.put('/profile', requireSingIt, updateProfileController)

//заказы
router.get('/orders', requireSingIt, getOrdersController)

//заказы
router.get('/all-orders', requireSingIt, isAdmin, getAllOrdersController)
